...
<html>
<head>
    <title>Registration WebApp</title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css">
    <link href="<c:url value='/static/css/app.css' />" rel="stylesheet">
</head>
<body ng-app="registration" class="ng-cloak">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="has-error" ng-show="userForm.$dirty">
                                ...
                                <span ng-show="userForm.uname.$error.minlength">Minimum length required is 3</span>
                                <span ng-show="userForm.uname.$invalid">This field is invalid </span>
                            </div>
                        </div>
                    </div>
                </div>
